        ...
        <div id="myTabContent" class="tab-content">
            <div class="row">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" for="DropUserGeneral">User</label>
                    <div class="col-sm-10">
                        <select name="simple" id="DropUserGeneral" class="form-control">
                            <option value="Test">Selection User</option>
                        </select>
                    </div>   </div>
                </div>
            </div>
            <div class="row">
                    <div class="col-md-8">
                    <label class="control-label"> <strong>ENTER ACTION IN JSON</strong> </label>
                                    <textarea id="textjson"  class="form-control" rows="20">
{
    "name": "Action_read_message",
    "timers": [
             {
            "name": "message",
            "interval": "seconds(4)",
