...
<div class="content">
    <div class="header">
        <h1 class="page-title">List Task</h1>

    </div>

    <div class="main-content">
        <div class="col-md-4">
            <a href='/nautilodrun.do' class="btn btn-primary" role='button'>Add</a></td></tr>
            <button id="btnlistTask" class="btn btn-primary"> refresh</button>
        </div>
