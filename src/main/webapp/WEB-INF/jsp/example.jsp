...
<head>
    ...
    <!-- Material Design -->
    <link rel="stylesheet" href="/resource/dist/css/bootstrap-material-design.min.css">
    <link rel="stylesheet" href="/resource/dist/css/ripples.min.css">
    <link rel="stylesheet" href="/resource/dist/css/MaterialAdminLTE.min.css">
    <!-- MaterialAdminLTE Skins. Choose a skin from the css/skins
         folder instead of downloading all of them to reduce the load. -->
    <link rel="stylesheet" href="/resource/dist/css/skins/all-md-skins.min.css">
    <!-- Morris chart -->
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="/users.do"><span class="fa fa-caret-right"></span> Users Add</a></li>
                <li><a href="/listuser.do"><span class="fa fa-caret-right"></span> Users List</a></li>

                <li><a href="/definitionsimple.do"><span class="fa fa-caret-right"></span> Agent Definitions Simple</a></li>
                <li><a href="/definitionadvanced.do"><span class="fa fa-caret-right"></span> Agent Definitions Advanced</a></li>
                <li><a href="/definitionsjson.do"><span class="fa fa-caret-right"></span> Agent Definitions JSON</a></li>
                <li><a href="/listdefinition.do"><span class="fa fa-caret-right"></span> Agent Definitions List</a></li>

                <li><a href="/agent.do"><span class="fa fa-caret-right"></span> Agents Add</a> </li>
                <li><a href="/agentscript.do"><span class="fa fa-caret-right"></span> Agents AgentScript</a></li>
                <li><a href="/listagent.do"><span class="fa fa-caret-right"></span> Agents List</a></li>

                <li><a href="/group.do"><span class="fa fa-caret-right"></span> Groups Add</a> </li>
                <li><a href="/groupagents.do"><span class="fa fa-caret-right"></span> Groups Group-Agents</a> </li>
                <li><a href="/listgroup.do"><span class="fa fa-caret-right"></span> Groups List</a></li>
                <li><a href="/suscribegroup.do"><span class="fa fa-caret-right"></span> Groups Suscribe</a></li>
                ...
                <li><a href="documentation/index.html"><i class="fa fa-book"></i> <span>Documentations</span></a></li>
...
<!-- Material Design -->
<script src="/resource/dist/js/material.min.js"></script>
<script src="/resource/dist/js/ripples.min.js"></script>
<script>
    $.material.init();
</script>
<!-- Morris.js charts -->
