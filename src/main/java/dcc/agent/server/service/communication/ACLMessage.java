...
public class ACLMessage implements Serializable {
    ...
    public ACLMessage(AgentServer agentServer, Performative performative, String sender, String receivers,
                      String replyTo, String conversationId, StringBuffer content, String language,
                      String enconding, String ontology, String protocol, String replyWith,
                      String inReplyTo, String replyBy, String status, Boolean update,
                      Boolean delegate
    ) {
        this.performative = performative;
    ...
    static synchronized public ACLMessage fromJson(AgentServer agentServer, User user, JSONObject agentJson, boolean update) throws AgentServerException, JSONException {
        ...
        String messageOntology = agentJson.optString("ontology", null);
        {
            if ((messageOntology == null) || messageOntology.trim().length() == 0) {
                ...
                messageOntology= String.valueOf((Integer.parseInt(messageOntology)+1));
